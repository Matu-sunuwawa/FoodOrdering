...
TOKEN: Final = '6504825039:AAEW4aZsxZIDJOShIJeMZlYbY26gV7qlvOY'
BOT_USERNAME: Final =  '@bbbanananabot'

#Commands
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text('Hello!!! Tanks for chatting with me! I am a banana!!!')
